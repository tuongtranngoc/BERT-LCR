...
def cli():
    ...
    parser.add_argument("--test_file", help="Path to testing folder")
...
if __name__ == "__main__":
    ...
    test_corpus = reformat(args.test_file, mode='test')
    ...
    json.dump(context_scores, open(os.path.join(args.out_dir, f'predictions.json'), 'wt'), ensure_ascii=False)
    logger.info("Done!")
